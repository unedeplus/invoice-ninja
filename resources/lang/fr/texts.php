...
return array(
  ...
  'gateway_help_1' => ':Lien d'inscription sur Authorize.net.',
  'gateway_help_2' => ':Lien d'inscription sur Authorize.net.',
  'gateway_help_17' => ':Lien pour utiliser votre API de signature PayPal.',
  'gateway_help_23' => 'Attention: utiliser votre clé API secrète, pas votre clé API publique.',
  'gateway_help_27' => ':Lien d'inscription pour TwoCheckout.',
  ...
  'edit_payment_details' => 'editer les paramètres de paiement',
  'token_billing' => 'Enregistrer les données de la carte',
  'token_billing_secure' => 'Les données sont enregistrées et sécurisées :stripe_link',
  ...
  'match_address' => '*L'adresse doit correspondre à celle de la carte de crédit.',
  ...
  'email_approved' => 'M'envoyer un mail lorsque le devis est <b>approuvé</b>',
  'notification_quote_approved_subject' => 'Quote :invoice was approved by :client',
  'notification_quote_approved' => 'The following client :client approved Quote :invoice for :amount.',
  'resend_confirmation' => 'Renvoi du courriel de confirmation',
  'confirmation_resent' => 'Le courriel de confirmation à été renvoyé',
  ...
  'iframe_url' => 'Website',
  'iframe_url_help1' => 'Copier le code suivant sur votre page web.',
  ...
  'page_expire' => 'Cette page va bientôt expirer , :click_here to keep working',
  'upcoming_quotes' => 'Devis à venir',
  'expired_quotes' => 'Devis expirés',

  'sign_up_using' => 'Sign up using',
  'invalid_credentials' => 'These credentials do not match our records',
  'show_all_options' => 'Montrer toutes les options',
